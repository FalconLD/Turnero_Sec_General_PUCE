    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('cubiculos.update', $cubiculo) }}" method="POST" id="edit-cubiculo-form">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $cubiculo->nombre) }}" required placeholder="Ej: C-101">
                                        </div>
                                        @error('nombre')
                            ...
                            <div class="row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="user_id" class="form-control @error('user_id') is-invalid @enderror" required>
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}" {{ old('user_id', $cubiculo->user_id) == $user->id ? 'selected' : '' }}>
                                                        {{ $user->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                {{-- Campo dinámico --}}
                                <div class="col-md-6" id="campo_extra_wrapper">
                                    <div class="form-group">
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const editForm = document.getElementById('edit-cubiculo-form'); // El formulario
